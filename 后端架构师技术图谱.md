...
* [《LSM树（Log-Structured Merge Tree）存储引擎》](https://blog.csdn.net/u014774781/article/details/52105708)
	...
	* 优化方式：Bloom filter 替代二分查找；compact 小数合并为大树，提高查询性能。
...
* [《计数排序和桶排序》](https://www.cnblogs.com/suvllian/p/5495780.html)
	* 对每一个元素x，确定小于x的元素个数，把x放到输出排序数组的正确位置上。
...
- [《一文搞懂分治算法》](https://segmentfault.com/a/1190000038845696)
  - 使用条件1：问题可以分解为若干规模较小、求解方式相同(似)的子问题。且子问题之间求解是独立的互不影响；
...
* [《Redis底层存储模型》](https://i6448038.github.io/2019/12/01/redis-data-struct/)
  * 根据长度、元素长度确定类型：字符串[int、sds]，列表[ziplist、双向链表]，hash[ziplist、哈希表]，set[intset、哈希表]，zset[ziplist、跳表]
...
+ [《Kafka高可用架构设计》](https://segmentfault.com/a/1190000039760185)
  ...
  + 副本机制用于消息备份（可选，如未设置可能导致leader宕机消息丢失）
  + 脑裂假死场景通过法定人数方式解决
...
+ [《深入学习MySQL事务：ACID特性的实现原理》](https://www.cnblogs.com/kismetv/p/10331633.html)
  ...
  * innodb 中 MVCC 用在 Repeatable-Read 隔离级别，MVCC 会产生幻读问题（更新时异常）
